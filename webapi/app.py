...
def load_model():
    ...
    try:
        ...
        encoder_session = ort.InferenceSession(f"{valid_path}/encoder_model.onnx", providers=['AzureExecutionProvider', 'CPUExecutionProvider'])
        decoder_session = ort.InferenceSession(
            f"{valid_path}/decoder_model_merged.onnx", providers=['AzureExecutionProvider', 'CPUExecutionProvider']
        )
